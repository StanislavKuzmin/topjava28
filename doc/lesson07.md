...
Если в контроллер мы добавим метод, который в теле ответа будет возвращать текст на кириллице, то увидим, что кодировка теряться. Для сохранения кодировки используем `StringHttpMessageConverter`,
