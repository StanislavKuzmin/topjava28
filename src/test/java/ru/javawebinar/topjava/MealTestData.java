...
public class MealTestData {
    ...
    public static final List<MealTo> userFilterMealTo1 = List.of(new MealTo(meal5.id(), meal5.getDateTime(), meal5.getDescription(), meal5.getCalories(), true),
            new MealTo(meal1.id(), meal1.getDateTime(), meal1.getDescription(), meal1.getCalories(), false));

    public static final List<MealTo> userFilterMealTo2 = List.of(new MealTo(meal3.id(), meal3.getDateTime(), meal3.getDescription(), meal3.getCalories(), false),
            new MealTo(meal2.id(), meal2.getDateTime(), meal2.getDescription(), meal2.getCalories(), false),
            new MealTo(meal1.id(), meal1.getDateTime(), meal1.getDescription(), meal1.getCalories(), false));
