...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void getBetweenAllDateTimeInRequest() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "filter/?startDate=2020-01-29&startTime=09:00" +
                "&endDate=2020-02-01&endTime=11:00"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MEAL_TO_MATCHER.contentJson(MealsUtil.getFilteredTos(meals, MealsUtil.DEFAULT_CALORIES_PER_DAY,
                        LocalTime.parse("09:00"), LocalTime.parse("11:00"))));
    }

    @Test
    void getBetweenSomeNullDateTimeInRequest() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "filter/?startDate=2020-01-29" +
                "&endDate=2020-02-01"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
